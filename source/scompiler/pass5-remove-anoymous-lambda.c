...
;
arg4
=   internal_make_closure_narg(3,&&pass5_mins_core_mins_list230_mins_cname,2,0);
    arg3
=init_from_int(0)
;
    arg2
...
;
 ...
 //
=   internal_make_closure_narg(8,&&pass5_mins_core229_mins_cname,2,0);
...
=regret;
    ...
    num_var = 2;
     ...
     POP(arg1);
     POP(arg0);
    CALL(     pass5_mins_core_mins_list230_mins_cname
,PASS14_MARK13);
     POP(arg7);
     POP(arg6);
     POP(arg5);
...
pass5_mins_core_mins_list230_mins_cname:
arg2
...
=    internal_car(arg1
    ...
    num_var = 2;
     ...
     POP(arg1);
     POP(arg0);
    CALL(     pass5_mins_core229_mins_cname
,PASS14_MARK23);
     POP(arg7);
     POP(arg6);
     POP(arg5);
...
.data.ge_vector)->data[0];
  { general_element tmp777
 //
=	init_from_string("error-can-not-bind")
;
   ((general_vector*)regslowvar.data.ge_vector)->data[1]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[1]
     PUSH(regslowvar
...
gemain:
regslowvar
=    internal_make_n_vector(162
);
arg0
=	init_from_symbol("generate-binding-list")
;
arg1
=	init_from_symbol("list")
;
arg2
=	init_from_symbol("pass5-core-list")
;
arg3
=	init_from_symbol("pass5-core")
;
arg4
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[0]
  { general_element tmp777
 //
=	init_from_symbol("pass5-remove-anoymous-lambda-list")
;
   ((general_vector*)regslowvar.data.ge_vector)->data[1]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[1]
  { general_element tmp777
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[2]
  { general_element tmp777
 //
=	init_from_symbol("pass5-remove-anoymous-lambda")
;
   ((general_vector*)regslowvar.data.ge_vector)->data[3]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[3]
  { general_element tmp777
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(7,&&pass5__compile70_mins_cname,3,0);
   ((general_vector*)regslowvar.data.ge_vector)->data[58]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[58]
     ((general_vector*)regslowvar.data.ge_vector)->data[107]
=init_from_int(1)
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(3,&&pass5__compile71_mins_cname,2,0);
   ((general_vector*)regslowvar.data.ge_vector)->data[108]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[108]
     ((general_vector*)regslowvar.data.ge_vector)->data[132]
=init_from_int(1)
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(29,&&pass5__compile72_mins_cname,2,0);
   ((general_vector*)regslowvar.data.ge_vector)->data[102]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[102]
     ((general_vector*)regslowvar.data.ge_vector)->data[42]
=init_from_int(1)
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[37]
  { general_element tmp777
 //
=    internal_get_build_in_ports( ((general_vector*)regslowvar.data.ge_vector)->data[37]
);
   ((general_vector*)regslowvar.data.ge_vector)->data[160]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[160]
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[141]
  { general_element tmp777
 //
=    internal_get_build_in_ports( ((general_vector*)regslowvar.data.ge_vector)->data[141]
);
   ((general_vector*)regslowvar.data.ge_vector)->data[36]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[36]
...
;
     ...
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[132]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
...
.data.ge_vector)->data[0];
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[49]
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[49]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[34]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[34]
  { general_element tmp777
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[129]
    ...
    num_var = 2;
   regret= ((general_vector*)regslowvar.data.ge_vector)->data[64]
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[159]
);
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[129]
);
     POP(arg1);
     POP(arg0);
    CALL(     *regret.data.function
...
;   ((general_vector*)regslowvar.data.ge_vector)->data[19]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[19]
  { general_element tmp777
 //
=   internal_make_closure_narg(1,&&pass5__compile74_mins_cname,2,0);
   ((general_vector*)regslowvar.data.ge_vector)->data[118]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[118]
  { general_element tmp777
 //
...
;   ((general_vector*)regslowvar.data.ge_vector)->data[46]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[46]
  { general_element tmp777
 //
=   internal_make_closure_narg(1,&&pass5__compile76_mins_cname,2,0);
   ((general_vector*)regslowvar.data.ge_vector)->data[103]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[103]
  { general_element tmp777
 //
...
.data.ge_vector)->data[0];
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[150]
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[150]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[63]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[63]
  { general_element tmp777
...
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[147]
);
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[26]
);
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[121]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
...
.data.ge_vector)->data[0];
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[125]
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[125]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[11]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[11]
  { general_element tmp777
...
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[125]
);
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[4]
);
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[114]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[31]
    ...
    num_var = 3;
   regret= ((general_vector*)regslowvar.data.ge_vector)->data[54]
;
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[113]
    ...
    num_var = 3;
   regret= ((general_vector*)regslowvar.data.ge_vector)->data[156]
;
...
;
arg1
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[153]
.data.ge_vector)->data[0];
arg4
=     ((general_vector*)arg1
.data.ge_vector)->data[0];
...
.data.ge_vector)->data[0];
arg0
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[123]
.data.ge_vector)->data[0];
arg4
=     ((general_vector*)arg0
.data.ge_vector)->data[0];
...
;
     ...
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[152]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
