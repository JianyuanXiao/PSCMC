...
;
 ...
 //
=   internal_make_closure_narg(32,&&pass5__compile71_mins_cname,2,0);
...
;
arg4
=   internal_make_closure_narg(3,&&self_mins_list225_mins_cname,2,0);
    arg3
=init_from_int(1)
;
arg2
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(34,&&pass5__compile72_mins_cname,2,0);
...
=    internal_cdr(arg1
    ...
    num_var = 2;
     ...
     POP(arg1);
     POP(arg0);
    CALL(     self_mins_list225_mins_cname
,PASS14_MARK7);
     POP(arg7);
     POP(arg6);
     POP(arg5);
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(5,&&rename_mins_settable238_mins_cname,2,0);
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(3,&&pass5__compile73_mins_cname,2,0);
...
rename_mins_settable238_mins_cname:
arg2
=     ((general_vector*)arg0
.data.ge_vector)->data[1];
arg3
...
.data.ge_vector)->data[2];
    ...
    num_var = 2;
     ...
     POP(arg1);
     POP(arg0);
    CALL(     rename_mins_settable238_mins_cname
,PASS14_MARK31);
     POP(arg7);
     POP(arg6);
     POP(arg5);
...
;
arg5
=   internal_make_closure_narg(3,&&map_mins_core171_mins_cname,3,0);
    arg4
=init_from_int(1)
;
arg3
...
;
    ...
    num_var = 3;
     ...
     POP(arg1);
     POP(arg0);
    CALL(     map_mins_core171_mins_cname
,PASS14_MARK64);
     POP(arg7);
     POP(arg6);
     POP(arg5);
...
gemain:
regslowvar
=    internal_make_n_vector(167
);
arg0
=	init_from_symbol("pass35-core")
;
arg1
=	init_from_symbol("pass35-remove-set!")
;
arg2
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(32,&&pass5__compile70_mins_cname,2,1);
   ((general_vector*)regslowvar.data.ge_vector)->data[51]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[51]
     ((general_vector*)regslowvar.data.ge_vector)->data[68]
=init_from_int(1)
...
;
  { general_element tmp777
 //
=   internal_make_closure_narg(3,&&pass5__compile75_mins_cname,3,1);
   ((general_vector*)regslowvar.data.ge_vector)->data[43]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[43]
     ((general_vector*)regslowvar.data.ge_vector)->data[42]
=init_from_int(1)
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[143]
  { general_element tmp777
 //
=    internal_get_build_in_ports( ((general_vector*)regslowvar.data.ge_vector)->data[143]
);
   ((general_vector*)regslowvar.data.ge_vector)->data[147]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[147]
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[56]
  { general_element tmp777
 //
=    internal_get_build_in_ports( ((general_vector*)regslowvar.data.ge_vector)->data[56]
);
   ((general_vector*)regslowvar.data.ge_vector)->data[40]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[40]
...
;
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[131]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[110]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[110]
  { general_element tmp777
...
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[110]
);
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[52]
    ...
    num_var = 3;
   regret= ((general_vector*)regslowvar.data.ge_vector)->data[66]
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[109]
);
...
;
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[121]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[5]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[5]
  { general_element tmp777
...
;
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[129]
    ...
    num_var = 2;
   regret= ((general_vector*)regslowvar.data.ge_vector)->data[59]
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[5]
);
...
;
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[140]
);
...
;
     ...
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[107]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
...
;
     ...
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[115]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
...
.data.ge_vector)->data[0];
 ...
 //((general_vector*)regslowvar.data.ge_vector)->data[152]
  { general_element tmp777
 //
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[152]
.data.ge_vector)->data[0];
   ((general_vector*)regslowvar.data.ge_vector)->data[32]=tmp777;}
 //((general_vector*)regslowvar.data.ge_vector)->data[32]
     PUSH(regslowvar
...
.data.ge_vector)->data[0];
arg0
=     ((general_vector*) ((general_vector*)regslowvar.data.ge_vector)->data[128]
.data.ge_vector)->data[0];
arg4
=     ((general_vector*)arg0
.data.ge_vector)->data[0];
...
;
     ...
     PUSH( ((general_vector*)regslowvar.data.ge_vector)->data[122]
);
     POP(arg2);
     POP(arg1);
     POP(arg0);
